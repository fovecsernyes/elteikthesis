...
% Dolgozat meta adatai
% Document's metadata
\title{Szoftver minőségi paramétereinek meghatározására szolgáló protokoll} % cím / title
\date{2021} % védés éve / year of defense

% Szerző meta adatai
% Author's metadata
\author{Vecsernyés Márk}
\degree{programtervező informatikus MSc}

% Témavezető(k) meta adatai
% Supervisor(s)' metadata
\supervisor{Kovács Attila} % belső témavezető neve / internal supervisor's name
\affiliation{??egyetemi tanár??} % belső témavezető beosztása / internal supervisor's affiliation
...
% Forrás-kódjegyzék (opcionális) - 3-5 kódpélda fölött érdemes
